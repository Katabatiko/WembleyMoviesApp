...
object StubTestRemoteService {
    ...
    val nobody = PersonDto(
        ...
        biography = "Tedio nacio en Madrid (España) en los años 60 del pasado siglo",
        birthday = "1964-02-19",
        deathday = null,
        gender = 1,
        homepage = null,
    ...
    val creditsDtoSpecial =  CreditsDto(
        id = 10000,
        cast = arrayOf(),
        crew = arrayOf(
            CrewDto(
            ...
            CrewDto(
                ...
                originalName = "Pedro Almodovar",
                popularity = 6.278f,
                profilePath = "/aucXNycAtFREMIKr6ikmHvd2Mmp.jpg",
                creditId = "5dbc9866d388ae",
                department = "Directing",
                job = "Director"
            ),
            CrewDto(
    ...
    val creditsDtoSpecial2 =  CreditsDto(
        id = 10002,
        cast = arrayOf(),
        crew = arrayOf(
            CrewDto(
    ...
    val results = arrayOf(movieDto1, movieDto3, movieDto2, movieDto4)
